...
public class NewCompetitor extends KendoFrame {
		...
		try {
			...
			if (clubs != null && clubs.size() > 0) {
				...
				if (ClubComboBox.getItemCount() > 0) {
					if (ClubPool.getInstance().get(KendoTournamentGenerator.getInstance().getLastSelectedClub()) != null) {
						ClubComboBox.setSelectedItem(ClubPool.getInstance().get(
								KendoTournamentGenerator.getInstance().getLastSelectedClub()));
					} else {
	...
	public RegisteredPerson acceptCompetitor() {
		if (ClubComboBox.getItemCount() > 0) {
			if (IDTextField.getText().length() > 0 && NameTextField.getText().length() > 0
				...
				RegisteredPerson comp = new RegisteredPerson(IDTextField.getText(), NameTextField.getText().trim(),
						...
						.addGroup(
								PanelLayout
										...
										.addGroup(
												PanelLayout
														.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
														.addComponent(PhotoLabel).addComponent(ClubLabel)
														.addComponent(IDLabel).addComponent(SurnameLabel)
										...
										.addGroup(
												PanelLayout
														...
														.addComponent(ClubComboBox, 0,
																javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
										.addContainerGap()));

		PanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] { CleanButton,
				ExploreButton });
						...
						PanelLayout
								...
								.addGroup(
										PanelLayout
												...
												.addComponent(IDTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 17,
								...
								.addGroup(
										PanelLayout
												...
												.addComponent(ClubComboBox, javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addGroup(
										PanelLayout
												...
												.addComponent(PhotoTextField, javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(CleanButton).addComponent(ExploreButton))
								.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));

		PanelLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] { IDTextField,
				NameTextField, PhotoTextField, SurnameTextField });
				...
				layout.createSequentialGroup()
						...
						.addGroup(
								layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
										.addComponent(Panel, javax.swing.GroupLayout.PREFERRED_SIZE, 207,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(PhotoPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(
								layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(SearchButton).addComponent(AcceptButton)
	...
	private void ExploreButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ExploreButtonActionPerformed
		String file;
		// photo.CleanPhoto();
		if (!(file = exploreWindow("Select", JFileChooser.FILES_ONLY)).equals("")) {
