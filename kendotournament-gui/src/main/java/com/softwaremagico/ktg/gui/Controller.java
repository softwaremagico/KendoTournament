...
public class Controller {
	...
	public Controller(MainGUI tmp_gui) {
		...
		if (!DatabaseConnection.getInstance().isDatabaseConnectionTested()
				&& DatabaseConnection.getInstance().getDatabaseEngine().equals(DatabaseEngine.SQLite)) {
	...
	class AddFightToPanelListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			shortFight = new ShortNewFight(tournamentPanel.getSelectedTournament(),
					tournamentPanel.getSelectedFightArea());
