...
public class FightPanel extends KFrame {
    ...
    public void updateSelectedTournament() {
        ...
        if (getSelectedTournament() != null
                ...
                || getSelectedTournament().getType().equals(TournamentType.TREE) || getSelectedTournament()
        ...
        if (getSelectedTournament() != null && (getSelectedTournament().getType().equals(TournamentType.PERSONALIZED) || getSelectedTournament().getType().equals(TournamentType.LEAGUE))) {
