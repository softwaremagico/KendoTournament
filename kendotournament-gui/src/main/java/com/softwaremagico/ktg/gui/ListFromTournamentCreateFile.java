...
public abstract class ListFromTournamentCreateFile extends KendoFrame {
	private static final long serialVersionUID = 1414110686745807640L;
	...
	public Tournament getSelectedTournament() {
		if (voidTournament) {
			if (TournamentComboBox.getSelectedIndex() > 0) {
				// return
				// listTournaments.get(TournamentComboBox.getSelectedIndex() -
				// 1); // -1 // avoid
	...
	private void initComponents() {
				...
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(layout.createSequentialGroup()
										.addComponent(CheckBox, javax.swing.GroupLayout.DEFAULT_SIZE, 215,
												Short.MAX_VALUE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(GenerateButton, javax.swing.GroupLayout.PREFERRED_SIZE, 140,
												javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGroup(layout.createSequentialGroup().addComponent(TournamentLabel)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(
										TournamentComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
				.addGap(4, 4, 4)
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false).addGroup(
						javax.swing.GroupLayout.Alignment.LEADING,
						layout.createSequentialGroup().addGap(6, 6, 6).addComponent(ArenaLabel)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(CancelButton).addComponent(CheckBox).addComponent(GenerateButton))
				.addContainerGap()));
		...
		if (refreshTournament) {
			try {
				if (changeLastSelectedTournament) {
					KendoTournamentGenerator.getInstance()
							.setLastSelectedTournament(TournamentComboBox.getSelectedItem().toString());
				}
			} catch (NullPointerException npe) {
