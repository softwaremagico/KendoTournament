...
public final class TournamentDesigner extends javax.swing.JFrame {
	...
	private void setLanguage() {
		...
		groupEditionLabel.setText(trans.getTranslatedText("GroupLabel"));
                maxFightsCheckBox.setText(trans.getTranslatedText("maxFightsCheckBox"));
	}
    ...
    private void initComponents() {
        ...
        maxFightsCheckBox = new javax.swing.JCheckBox();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(TeamScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 594, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        maxFightsCheckBox.setText("Create all possible fights");
        ...
        ButtonPanelLayout.setHorizontalGroup(
            ...
            .addGroup(ButtonPanelLayout.createSequentialGroup()
                .addComponent(maxFightsCheckBox)
			...
			if (AlertManager.questionMessage("questionCreateFight", "Warning!")) {
				...
				try {
					if (FightPool.getInstance().add(getSelectedTournament(), TournamentManagerFactory
							.getManager(getSelectedTournament(), getDefinedType()).createSortedFights(maxFightsCheckBox.isSelected(), 0))) {
    ...
    private javax.swing.JCheckBox maxFightsCheckBox;
