...
public final class TournamentDesigner extends javax.swing.JFrame {
	...
	private void addDesignedPanelToLevelZero() {
		try {
			if (TournamentManagerFactory.getManager(getSelectedTournament(), getDefinedType()).getGroups(0)
					.size() < getNumberOfGroupsOfLeague()) {
				int defaultArena = 0;
		...
		try {
			...
			if (groupBox != null) {
				if (getSelectedTournament().getType().equals(TournamentType.CUSTOM_CHAMPIONSHIP)) {
					CustomChampionship championship = (CustomChampionship) TournamentManagerFactory
							.getManager(getSelectedTournament(), getDefinedType());
					championship.removeLinks();
				}
				TournamentManagerFactory.getManager(getSelectedTournament(), getDefinedType())
						.removeGroup(groupBox.getTournamentGroup());
				TournamentManagerFactory.getManager(getSelectedTournament(), getDefinedType()).setDefaultFightAreas();
				updateInfo();
			}
		} catch (NullPointerException npe) {
	...
	private void updateLevel() {
		...
		for (int i = 0; i < TournamentManagerFactory.getManager(getSelectedTournament(), getDefinedType())
				.getNumberOfLevels(); i++) {
			if (i < TournamentManagerFactory.getManager(getSelectedTournament(), getDefinedType()).getNumberOfLevels()
					- 2) {
				levelComboBox
						.addItem(
								trans.getTranslatedText("Round") + " "
										+ (TournamentManagerFactory
												.getManager(getSelectedTournament(), getDefinedType())
												.getNumberOfLevels() - i));
			} else if (i == TournamentManagerFactory.getManager(getSelectedTournament(), getDefinedType())
					.getNumberOfLevels() - 2) {
	...
	private void initComponents() {
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(jPanel1Layout
												...
												.addComponent(addGroupButton, javax.swing.GroupLayout.DEFAULT_SIZE, 149,
														Short.MAX_VALUE)
										.addComponent(deleteButton, javax.swing.GroupLayout.DEFAULT_SIZE, 149,
												Short.MAX_VALUE).addComponent(deleteAllButton,
								...
								.addGroup(jPanel1Layout
										...
										.addComponent(deleteLevelButton, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(PassLabel).addComponent(winnerPassSpinner,
										javax.swing.GroupLayout.PREFERRED_SIZE, 149,
										javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(BlackBoardScrollPane).addContainerGap()));

		jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] { addGroupButton,
				deleteAllButton, deleteButton, deleteLevelButton, levelComboBox, winnerPassSpinner });
		...
		jPanel1Layout
				.setVerticalGroup(
						jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addComponent(deleteAllButton).addGap(18, 18, 18).addComponent(deleteLevelLabel)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								...
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(winnerPassSpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addComponent(BlackBoardScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 297, Short.MAX_VALUE))
						.addContainerGap()));

		jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] { addGroupButton,
				deleteAllButton, deleteButton, deleteLevelButton, levelComboBox });
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addComponent(addTeamButton, javax.swing.GroupLayout.PREFERRED_SIZE, 148,
										javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(deleteTeamsButton, javax.swing.GroupLayout.PREFERRED_SIZE, 148,
								javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(cleanLinksButton,
										javax.swing.GroupLayout.PREFERRED_SIZE, 148,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(TeamScrollPane).addContainerGap()));

		jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { addTeamButton, cleanLinksButton, deleteTeamsButton });
				...
				.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel2Layout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
										false)
								.addGroup(jPanel2Layout.createSequentialGroup().addComponent(groupEditionLabel)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						...
						.addComponent(TeamScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 122,
								javax.swing.GroupLayout.PREFERRED_SIZE))
		...
		ButtonPanelLayout
				.setHorizontalGroup(ButtonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(ButtonPanelLayout.createSequentialGroup().addContainerGap(494, Short.MAX_VALUE)
								.addComponent(acceptButton, javax.swing.GroupLayout.PREFERRED_SIZE, 138,
										javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(closeButton)));

		ButtonPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { acceptButton, closeButton });
				...
				.setVerticalGroup(
						ButtonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(ButtonPanelLayout
										...
										.addComponent(acceptButton).addComponent(closeButton)));
				...
				layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								...
								.addGroup(javax.swing.GroupLayout.Alignment.LEADING,
										layout.createSequentialGroup().addComponent(TournamentLabel)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				.addComponent(ButtonPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
	...
	private void winnerPassSpinnerStateChanged(javax.swing.event.ChangeEvent evt) {// GEN-FIRST:event_winnerPassSpinnerStateChanged
		if (refreshSpinner) {
			try {
				TournamentManagerFactory.getManager(getSelectedTournament(), getDefinedType())
						.setHowManyTeamsOfGroupPassToTheTree((Integer) winnerPassSpinner.getValue());
			...
			if (AlertManager.questionMessage("questionCreateFight", "Warning!")) {
				...
				try {
					if (FightPool.getInstance().add(getSelectedTournament(), TournamentManagerFactory
						...
						if (getSelectedTournament().getType().equals(TournamentType.CUSTOM_CHAMPIONSHIP)) {
							// Add new links.
							CustomLinkPool.getInstance().add(getSelectedTournament(),
									((LeagueLevelCustom) TournamentManagerFactory.getManager(getSelectedTournament())
											.getLevel(0)).getLinks());
						}
	...
	private void deleteLevelButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_deleteLevelButtonActionPerformed
		...
		try {
			if (levelComboBox.getSelectedIndex() == levelComboBox.getItemCount() - 1) {
				...
				AlertManager.translatedMessage(this.getClass().getName(), "fightsDeleted", "MySQL",
						JOptionPane.INFORMATION_MESSAGE);
			} else {
				FightPool.getInstance().remove(getSelectedTournament(), levelComboBox.getSelectedIndex());
				TournamentManagerFactory.getManager(getSelectedTournament(), getDefinedType())
						.removeTeams(levelComboBox.getSelectedIndex() > 0 ? levelComboBox.getSelectedIndex() : 1);
				// Remove previous level winners.
				// if (levelComboBox.getSelectedIndex() > 0) {
				// TournamentManagerFactory.getManager(getSelectedTournament(),
				// getDefinedType())
				// .removeWinners(levelComboBox.getSelectedIndex() - 1);
				// }
				AlertManager.translatedMessage(this.getClass().getName(), "fightsDeleted", "MySQL",
						JOptionPane.INFORMATION_MESSAGE);
			}
