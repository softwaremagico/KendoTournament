...
public class ChooseScoreGUI extends javax.swing.JFrame {
    ...
    private void selectStyle() {
        refreshing = true;
        try {
            if (listTournaments.get(TournamentComboBox.getSelectedIndex()).getChoosedScore().equals("European")) {
                EuropeanRadioButton.setSelected(true);
            } else if (listTournaments.get(TournamentComboBox.getSelectedIndex()).getChoosedScore().equals("Custom")) {
