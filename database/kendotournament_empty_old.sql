...
--
-- Current Database: `kendotournament`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `kendotournament` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='competitor in the tournament. Each line for each one. ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fight` (
  ...
  CONSTRAINT `Team1Fight` FOREIGN KEY (`Team1`, `LeagueLevel`, `Tournament`) REFERENCES `team` (`Name`, `LevelTournament`, `Tournament`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `Team2Fight` FOREIGN KEY (`Team2`, `LeagueLevel`, `Tournament`) REFERENCES `team` (`Name`, `LevelTournament`, `Tournament`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `tournament` (
  ...
  `Banner` mediumblob NOT NULL COMMENT 'Banner to be shown on the event.',
...
-- Dump completed on 2011-11-03 13:31:18
