...
public class ChampionshipTest {
    ...
    public void solveFirstLevel() throws SQLException {
        ...
        Assert.assertEquals(ranking2.getTeam(0), TeamPool.getInstance().get(tournament, "Team05"));
        Assert.assertEquals(ranking2.getTeam(1), TeamPool.getInstance().get(tournament, "Team06"));
    }
