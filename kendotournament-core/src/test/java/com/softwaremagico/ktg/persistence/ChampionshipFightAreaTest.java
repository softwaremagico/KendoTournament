...
public class ChampionshipFightAreaTest {
	...
	private static final Integer FIGHTS_AREA = 2;
	...
	public void createTournamentGroups() throws SQLException {
		Assert.assertTrue(tournament.getFightingAreas() == FIGHTS_AREA);
	...
	public void solveFourthLevel() throws SQLException, PersonalizedFightsException {
		FightPool.getInstance().add(tournament, TournamentManagerFactory.getManager(tournament).createSortedFights(false, 3));
