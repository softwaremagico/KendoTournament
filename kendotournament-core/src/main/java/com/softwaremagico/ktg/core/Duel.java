...
public class Duel implements Comparable<Duel> {
     ...
     *
     * @param playerA if true, gets scored from player of the first team, if
     * false from player of the other team.
     * @return
     */
     ...
     * @param firstTeamPlayer True if is the firstTeamPlayer who caused the hit,
     * false if is the player2.
