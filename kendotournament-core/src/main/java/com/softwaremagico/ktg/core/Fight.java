...
public class Fight implements Comparable<Fight> {
	...
	private void completeIppons() {
		for (int i = 0; i < team1.getNumberOfMembers(level); i++) {
			// There is a player
			if (((i < team2.getNumberOfMembers(level) && team2.getMember(i, getIndex()) != null) && (!team2
					.getMember(i, getIndex()).getName().equals("") || !team2.getMember(i, getIndex()).getId()
					.equals("")))
					&& ((team1.getMember(i, getIndex()) == null)
					// Versus no player
					|| (team1.getMember(i, getIndex()).getName().equals("") && team1.getMember(i, getIndex()).getId()
							.equals("")))) {
		...
		for (int i = 0; i < team2.getNumberOfMembers(level); i++) {
			// There is a player.
			if (((i < team1.getNumberOfMembers(level) && team1.getMember(i, getIndex()) != null) && (!team1
					.getMember(i, getIndex()).getName().equals("") || !team1.getMember(i, getIndex()).getId()
					.equals("")))
					&& ((team2.getMember(i, getIndex()) == null)
					// Versus no player
					|| (team2.getMember(i, getIndex()).getName().equals("") && team2.getMember(i, getIndex()).getId()
							.equals("")))) {
