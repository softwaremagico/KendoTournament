...
public class ScoreOfCompetitorEuropean implements Comparable<ScoreOfCompetitorEuropean> {
    ...
    public ScoreOfCompetitorEuropean(RegisteredPerson competitor, List<Fight> fights) {
    ...
    @Override
    public int compareTo(ScoreOfCompetitorEuropean o) {
