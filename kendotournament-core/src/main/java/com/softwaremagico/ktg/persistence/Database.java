...
public abstract class Database {
	 ...
	 *            show error messages.
	 * @param retry
	 *            do another try if can solve the SQL problem.
	 * @return true if the connection is ok.
	 */
	protected abstract boolean connect(String password, String user, String database, String server, boolean verbose,
			boolean retry) throws CommunicationsException, SQLException;
	...
	protected abstract boolean updateRegisteredPeople(Map<RegisteredPerson, RegisteredPerson> peopleExchange)
			throws SQLException;
	...
	protected abstract boolean updateRoles(Tournament tournament, Map<Role, Role> rolesExchange) throws SQLException;
	...
	protected abstract boolean updateClubs(Map<Club, Club> clubsExchange) throws SQLException;
	...
	protected abstract boolean updateTournaments(Map<Tournament, Tournament> tournamentsExchange) throws SQLException;
	...
	protected abstract boolean updateTeams(Map<Team, Team> teamsExchange) throws SQLException;
	...
	protected abstract boolean updateFights(Map<Fight, Fight> fightsExchange) throws SQLException;
	...
	protected abstract boolean updateDuels(Map<Duel, Duel> duelsExchange) throws SQLException;
	...
	protected abstract boolean updateUndraws(Map<Undraw, Undraw> undrawsExchange) throws SQLException;
	...
	protected abstract boolean updateCustomWinnerLinks(Map<CustomWinnerLink, CustomWinnerLink> customWinnerLinks)
			throws SQLException;
