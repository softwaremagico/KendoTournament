...
public class SQLite extends SQL {
    ...
    private void createTableClub() throws SQLException {
        String sqlQuery = "CREATE TABLE \"club\" (" + "\"Name\" varchar(50) NOT NULL,"
                + "\"Country\" varchar(20) NOT NULL," + "\"Representative\" varchar(12) DEFAULT NULL,"
                + "\"Mail\" varchar(50) DEFAULT NULL," + "\"Phone\" integer DEFAULT NULL,"
                + "\"City\" varchar(20) DEFAULT NULL," + "\"Web\" varchar(100) DEFAULT NULL,"
                + "\"Address\" varchar(100) DEFAULT NULL," + "PRIMARY KEY (Name)" + ")";
    ...
    private void createTableCustomLink() throws SQLException {
        String sqlQuery = "CREATE TABLE \"customlinks\" (" + "\"Tournament\" varchar(50) NOT NULL,"
     ...
     */
    @Override
    protected synchronized boolean addRegisteredPeople(List<RegisteredPerson> people) throws SQLException {
        return super.addRegisteredPeople(people);
    }

    @Override
    protected synchronized List<RegisteredPerson> getRegisteredPeople() throws SQLException {
        return super.getRegisteredPeople();
    }

    @Override
    protected synchronized boolean removeRegisteredPeople(List<RegisteredPerson> people) throws SQLException {
        return super.removeRegisteredPeople(people);
    }

    @Override
    protected synchronized boolean updateRegisteredPeople(HashMap<RegisteredPerson, RegisteredPerson> peopleExchange) throws SQLException {
        return super.updateRegisteredPeople(peopleExchange);
    }

    @Override
    protected synchronized Photo getPhoto(String competitorId) throws SQLException {
        return super.getPhoto(competitorId);
    }

    @Override
    protected synchronized boolean setPhotos(List<Photo> photos) throws SQLException {
        return super.setPhotos(photos);
    }
    ...
    protected synchronized List<CustomWinnerLink> getCustomWinnerLinks(Tournament tournament) throws SQLException {
        return super.getCustomWinnerLinks(tournament);
    }

    @Override
    protected synchronized boolean addCustomWinnerLinks(List<CustomWinnerLink> customWinnerLinks) throws SQLException {
        return super.addCustomWinnerLinks(customWinnerLinks);
    }

    @Override
    protected synchronized boolean removeCustomWinnerLinks(List<Tournament> tournaments) throws SQLException {
        return super.removeCustomWinnerLinks(tournaments);
    }

    @Override
    protected synchronized boolean updateCustomWinnerLinks(HashMap<CustomWinnerLink, CustomWinnerLink> customWinnerLinks) throws SQLException {
        return super.updateCustomWinnerLinks(customWinnerLinks);
    }
